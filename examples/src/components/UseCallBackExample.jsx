...
const UseMemoAndCallbackHook = () => {
  ...
  // const squaredValueUseCallback = squaredValue; --> this will trigger for each counter-2 changes
  // suppose we want to trigger only for counter changes and the counter2 value is not changing so we can use useCallback
  ...
  return (
    ...
    */}
      ...
      {/* <h5>
        Question 4: What is useCallback in React? How is it different from
        useMemo ?
      </h5> */}
      {/* 
    ...
    */}
      ...
      {/* 
        ...
        For example: For the above function - we will only have 100 as the value of counter2
    */}
