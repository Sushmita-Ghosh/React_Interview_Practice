...
The term "render prop" is a technique for _sharing code_ between react components using _a prop whose value is a function_
...
**_Below is the container which implements the render props pattern_**
`Counter.js`
...
_The below two counters use the props counter and increment counter_
...
**_Now in App.js we can use the Counter component and use the "render" prop to pass the count and incrementCount_**
...
## <a name="lidi"></a><h2>LAZY IMPORT, DYNAMIC IMPORT</h2>
...
## <a name="scomp"></a><h2>STATELESS COMPONENTS</h2>
...
## <a name="ptypes"></a><h2>PROP TYPES</h2>
...
## <a name="server-side"></a><h2>SERVER SIDE RENDERING OF COMPONENTS</h2>
...
## <a name="skey"></a><h2>SIGNIFICANCE OF "KEY" ATTRIBUTE</h2>
...
## <a name="droute"></a><h2>DYNAMIC ROUTING</h2>
...
## <a name="context"></a><h2>CONTEXT API VS REDUX</h2>
...
## <a name="diff"></a><h2> VIRTUAL DOM, RECONCILIATION, DIFFING ALGORITHM</h2>
...
## <a name="fibre"></a><h2>REACT FIBRE</h2>
...
**5. Improved support for animations**
